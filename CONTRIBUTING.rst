...
When `reporting a bug <https://github.com/OpenEnergyPlatform/omi/issues>`_ please include:
...
1. Fork `omi <https://github.com/OpenEnergyPlatform/omi>`_
...
.. [1] If you don't have all the necessary python versions available locally you can rely on Travis - it will
       `run the tests <https://travis-ci.org/OpenEnergyPlatform/omi/pull_requests>`_ for each change you add in the pull request.
