...
from ..base.parser import _TestParser as Base, parse_date
...
class TestParser(Base):
    ...
    _input_file = 'data/metadata_v14.json'
    _expected_result = s.OEPMetadata(
        ...
        temporal=s.Temporal(
            ...
            start=datetime.datetime(2017,1,1,0,0, tzinfo=datetime.timezone(datetime.timedelta(0, 3600))),
            end=datetime.datetime(2017,12,31,23,0, tzinfo=datetime.timezone(datetime.timedelta(0, 3600))),
            resolution="1 h"),
        sources=[
            s.Source(
        ...
        contributors=[
            ...
            s.Contributor(
                ...
                obj="metadata",
                comment="Update metadata version 1.3: move reference_date into"\
                        "temporal and remove some array")],
        resources=[
            s.Resource(
