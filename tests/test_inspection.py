...
def test_inspection():
    ...
    assert metadata["resources"][0]["schema"]["fields"][2]["type"] == "number"
    assert metadata["resources"][0]["schema"]["fields"][3]["type"] == "array"
    assert metadata["resources"][0]["schema"]["fields"][4]["type"] == "array"
    assert metadata["resources"][0]["schema"]["fields"][5]["type"] == "array"
