...
from omi.schemas import METADATA_SCHEMA_v1_3_0
from omi.schemas import METADATA_SCHEMA_v1_4_0

METADATA_EXAMPLE_v1_3_0 = json.loads(
    """{"title": "",
    "description": "",
    "language": [ "eng", "ger" ],
    "spatial": 
    ...
    "_comment": {
        ...
        "_additional_information": {
            ...
            "_none": "If not applicab18le use 'none'"} } }"""
)

METADATA_EXAMPLE_v1_4_0 = json.loads(
...
def test_schema_v130_against_example_of_v130_which_should_succeed():
    assert jsonschema.validate(METADATA_EXAMPLE_v1_3_0, METADATA_SCHEMA_v1_3_0) == None


def test_schema_v140_against_example_of_v140_which_should_succeed():
    assert jsonschema.validate(METADATA_EXAMPLE_v1_4_0, METADATA_SCHEMA_v1_4_0) == None
